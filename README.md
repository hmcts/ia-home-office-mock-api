...
The intention is that this will be used while the Home Office services are unavailablem, which will generally be the case in all lower environments.

The code is generated by running a gradle task. The code generated is then copied into the relevant directory.
