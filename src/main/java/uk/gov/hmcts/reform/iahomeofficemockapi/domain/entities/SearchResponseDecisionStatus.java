...
import uk.gov.hmcts.reform.iahomeofficemockapi.domain.entities.SearchResponseDecisionStatusApplicationType;
import uk.gov.hmcts.reform.iahomeofficemockapi.domain.entities.SearchResponseDecisionStatusClaimReasonType;
import uk.gov.hmcts.reform.iahomeofficemockapi.domain.entities.SearchResponseDecisionStatusDecisionCommunication;
import uk.gov.hmcts.reform.iahomeofficemockapi.domain.entities.SearchResponseDecisionStatusDecisionType;
import uk.gov.hmcts.reform.iahomeofficemockapi.domain.entities.SearchResponseDecisionStatusRejectionReasons;
import uk.gov.hmcts.reform.iahomeofficemockapi.domain.entities.SearchResponseDecisionStatusRoleSubType;
import uk.gov.hmcts.reform.iahomeofficemockapi.domain.entities.SearchResponseDecisionStatusRoleType;
